...
function t2() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Marina')
        .then(function (response) {
            return response.text();
        })
        .then(response => {
...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=9&num2=1')
        .then(function (response) {
            return response.text();
        })
        .then(response => {
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=7&num2=3')
        .then(function (response) {
            return response.text();
        })
        .then(response => {
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=7&num2=3')
        .then(function (response) {
            return response.text();
        })
        .then(response => {
...
function t8() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=8&year=1988')
        .then(function (response) {
            return response.text();
        })
        .then(response => {
...
function t11() {
    fetch('http://getpost.itgid.info/index2.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
        body: 'auth=DdC33D7d2C2a7&action=2&name=Marina'
    })
        .then(response => response.text())
        .then(response => {
            // console.log(response);
...
function t12() {
    fetch('http://getpost.itgid.info/index2.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
        body: 'auth=DdC33D7d2C2a7&action=3&num1=3&num2=5'
    })
        .then(response => response.text())
        .then(response => {
            // console.log(response);
...
function t13() {
    fetch('http://getpost.itgid.info/index2.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
        body: 'auth=DdC33D7d2C2a7&action=4&num1=9&num2=7'
    })
        .then(response => response.text())
        .then(response => {
            //  console.log(response);
...
function t15() {
    fetch('http://getpost.itgid.info/index2.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
        body: 'auth=DdC33D7d2C2a7&action=4&num1=8&num2=3'
    })
        .then(response => response.text())
        .then(response => {
            // console.log(response);
...
function t17() {
    fetch('http://getpost.itgid.info/index2.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
        body: 'auth=DdC33D7d2C2a7&action=8&year=1988'
    })
        .then(response => response.text())
        .then(response => {
            //  console.log(response);
