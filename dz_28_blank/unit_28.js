...
let goods = new Goods('apple', 55, 'https://st.depositphotos.com/2204074/4919/i/950/depositphotos_49196663-stock-photo-apples-sliced.jpg', 32)
console.log(goods);
goods.draw('.out-1')

let goods2 = new Goods('pear', 22, 'img/2.png', 17)
console.log(goods2);
goods2.draw('.out-4')


let goods3 = new Goods2('mango', 27, 'img/3.png', 23, true)
console.log(goods3);
goods3.draw('.out-6')

let aValid = new Valid('Marin', 'maryn');
aValid.validate();
console.log(aValid.isValid);

let bValid = new Valid('MariShe', 'mariska');
bValid.validate();
console.log(bValid.isValid);

let valid2 = new Valid2('', '12345')
valid2.validate()
console.log(valid2);

let valid3 = new Valid2('marishechka', '123456')
valid3.validate();
console.log(valid3);
