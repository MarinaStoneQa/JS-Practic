...
document.querySelector('.three').innerHTML = '<h3>Самый распространенный язык для написания приложений на стороне сервера - PHP. Язык созданный и разработанный для WEB. Я рекомендую начинать изучение backend именно с него. После изучения PHP, языки Node, Python - изучаются значительно быстрее. Курс позволяет изучить все аспекты PHP для разработки сложного сайта статей с категориями и тегами, админ панелью, ролями пользователей, авторизацией регистрацией и разместить сайт на сервере ( деплой проекта). </h3>'
...
document.querySelector('.three').innerHTML += '<h4>Самый распространенный язык для написания приложений на стороне сервера - PHP. Язык созданный и разработанный для WEB. Я рекомендую начинать изучение backend именно с него. </h4> <p> После изучения PHP, языки Node, Python - изучаются значительно быстрее. Курс позволяет изучить все аспекты PHP для разработки сложного сайта статей с категориями и тегами, админ панелью, ролями пользователей, авторизацией регистрацией и разместить сайт на сервере ( деплой проекта). <p/>'
