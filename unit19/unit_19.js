...
function t4() {
    ...
    div = document.querySelector('.div-4');
    out.innerHTML = div.innerHTML
}
...
function t5() {
    ...
    div = document.querySelector('.div-5');
    out.innerHTML = div.classList.toggle('active');
}
...
function t6() {
    div = document.querySelector('.ul-6');
...
function t7() {
    div = document.querySelector('.div-7');
...
function t15() {
    a = document.querySelector('.div-15').innerHTML;
    a++;
    document.querySelector('.div-15').innerHTML = a

}
document.querySelector('.div-15').onmouseover = t15


// Task 16 ============================================
/*  Дан блок .div-16. Добавьте на него событие move. При каждом движении мыши увеличивайте ширину блока на 1px. */

wid16 = document.querySelector('.div-16').clientWidth;

function t16() {
    document.querySelector('.div-16').style.width = wid16 + 'px';
    wid16++;
...
function t18() {
    wid = document.querySelector('.div-18').offsetWidth;
    document.querySelector('.div-18').innerHTML = wid
}
...
function t19() {
    div = document.querySelector('.div-19').className;
    document.querySelector('.div-19').innerHTML = div
}
