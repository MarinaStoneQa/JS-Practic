...
function t4() {
    a4_res = a4.filter(elem => typeof elem !== "string")
    return a4_res
}
...
function t7() {
    a7_res = []
    a7.map(function (elem) {
        a7_res.push(elem.toLowerCase())
    });
    return a7_res
...
function t14() {
    let a14 = ['c', 'C', 'd', 'e', 'E'];
    let a14_sym = 'D';
    return a14.includes(a14_sym.toLowerCase() || a14_sym.toUpperCase())
}
