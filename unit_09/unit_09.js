...
function f6() {
    ...
    let tag = document.getElementsByClassName('p-6').length;
    out.innerHTML = tag
}
...
function f11() {
    ...
    m.innerHTML = '25';
    document.querySelector('.out-11').appendChild(m)
}
...
function f12() {
    let m = document.createElement('div');
    m.innerHTML = '12';
    m.classList.add('bg-12');
    document.querySelector('.out-12').appendChild(m)
}
...
function f13() {
    let m = document.createElement('div');
    m.innerHTML = 'pushMe';
    m.classList.add('bg-13');
    m.onclick = function f13_1() {
        document.querySelector('.out-13-1').innerHTML += this.innerHTML;
    }
    document.querySelector('.out-13').appendChild(m);
}
...
function f14() {
    let m = document.createElement('div');
    m.innerHTML = '14';
    m.classList.add('bg-14');
    document.querySelector('.out-14').prepend(m);
}
...
function f15() {
    let m = document.createElement('div');
    m.innerHTML = '15';
    m.classList.add('bg-15');
    document.querySelector('.out-15').before(m);
}
...
function f16() {
    let m = document.createElement('div');
    m.innerHTML = '16';
    m.classList.add('bg-16');
    document.querySelector('.out-16').after(m);
}
...
function f17() {
    let m = document.createElement('div')
    m.innerHTML = '17';
    m.classList.add('bg-17')
    document.querySelector('.out-17').replaceWith(m)
}
...
function f18() {
    ...
    let m = document.querySelector('.p-18').getAttribute('data-b')
    out.innerHTML = m
}
...
function f20() {
    let m = document.querySelector('.out-20')
    m.setAttribute('title', 'go')
}
