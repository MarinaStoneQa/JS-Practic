...
function f4() {
    let myBox = document.querySelector(".i-4");
...
function f5() {
    let myBox = document.querySelector(".i-5");
...
function f7() {
    let parol = document.querySelector(".i-7").value;
    let out1 = document.querySelector(".out-71");
    let out2 = document.querySelector(".out-72");
    out1.innerHTML = document.querySelector(".i-7").value;
    if (parol.length >= 6) {
        out2.innerHTML = 1;
    } else {
        out2.innerHTML = 0;
...
function f8() {
    document.querySelector(".out-8").innerHTML =
        '<input type="text"  class="i-81" value=""> <button class="b-81"> BUTTON </button>';
...
function f81() {
    ...
    out.innerHTML = document.querySelector(".i-81").value;
}
...
function f9() {
    let myRadio = document.querySelector(".r-9");
...
function f10() {
    document.querySelector(
        ".out-10"
    ).style.backgroundColor = document.querySelector(".i-10").value;
}
...
function f12() {
    ...
    out.innerHTML = document.querySelector(".i-12").value;
}
...
function f13() {
    ...
    out.innerHTML = document.querySelector(".i-13").value;
}
...
function f14() {
    ...
    out.innerHTML = document.querySelector(".t-14").value;
}
...
function f15() {
    ...
    out.innerHTML = document.querySelector(".t-15").value;
}
